        ...
        const sidebarHtml = `
            <aside id="sidebar" class="w-16 hover:w-64 bg-gray-900 shadow-md h-screen sticky top-0 flex flex-col transition-all duration-300 group overflow-hidden">
                ...
                <div class="px-2 py-4 border-t border-gray-800">
                    <button onclick="logout()" class="flex items-center w-full px-3 py-3 text-gray-400 hover:bg-gray-800 hover:text-white rounded-md group/item">
                        <svg class="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 713-3h4a3 3 0 013 3v1"></path></svg>
